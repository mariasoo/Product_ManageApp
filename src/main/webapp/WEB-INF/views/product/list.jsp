    ...
    <div class="row">
        ...
        <div class="row content">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">상품 조회</h5>
                        <form action="/product/list" method="get">
                            <input type="hidden" name="size" value="${pageRequestDTO.size}">
                           <div class="mb-3">

                                <input type="checkbox" name="types"
                                       value="p"  ${pageRequestDTO.checkType("p")?"checked":""}>상품 이름
        ...
        <div class="row content">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">상품 조회 목록</h5>
                        <table class="table">
                            <thead>
                            <tr>
                        ...
                        <div class="float-end">
                            <ul class="pagination flex-wrap">
                                <c:if test="${responseDTO.prev}">
                                    <li class="page-item">
                                        <a class="page-link" data-num="${responseDTO.start -1}">Previous</a></li>
                                </c:if>
